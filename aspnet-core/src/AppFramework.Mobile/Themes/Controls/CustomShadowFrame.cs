...
namespace AppFramework.Shared.Controls
{
    ...
    public class CustomShadowFrame : Frame
    {
        ...
        public static readonly BindableProperty ShadowOpacityProperty =
            BindableProperty.Create(nameof(ShadowOpacity), typeof(float), typeof(CustomShadowFrame), 0f, BindingMode.Default);
        ...
        public static readonly BindableProperty ShadowOffSetHeightProperty =
            BindableProperty.Create(nameof(ShadowOffSetHeight), typeof(float), typeof(CustomShadowFrame), 0f, BindingMode.Default);
