...
{
    public partial class SelectionUserOrRoleView : ContentView
    {
        private readonly IMessenger messenger;

        public SelectionUserOrRoleView()
        {
            InitializeComponent();
            messenger= ContainerLocator.Container.Resolve<IMessenger>();
            messenger.Sub<bool>("SelectionUserOrRoleViewIsVisible", OrganizationViewIsVisibleHandler);
        }
        ...
        public void Hide()
        {
            ...
            parentAnimation.Commit(this, "HideCloseSelectionUserOrRoleView");
        }

        private void CloseSelectionUserOrRoleView(object sender, System.EventArgs e)
        {
            this.Hide();
        }
    }
